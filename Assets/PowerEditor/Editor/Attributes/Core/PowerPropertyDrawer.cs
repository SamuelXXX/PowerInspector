    ...
    public class PowerEditingOption
    {
        ...
        public void ModifyOptionIncrement(PowerPropertyAttribute ppa, SerializedObject serializedObject, SerializedProperty property, FieldInfo fieldInfo)
        {
            ...
            if (ppa is ColorThemeAttribute)
            {
                ...
                if (!Application.isPlaying)
                {
                    if (PowerEditorUtility.CheckColorCodeValid(ct.fontColor))
                    {
                        fontColor = PowerEditorUtility.ColorCode2Color(ct.fontColor);
                    }

                    if (PowerEditorUtility.CheckColorCodeValid(ct.backgroundColor))
                    {
                        backgroundColor = PowerEditorUtility.ColorCode2Color(ct.backgroundColor);
                    }
                }
                else
                {
                    if (PowerEditorUtility.CheckColorCodeValid(ct.runtimeFontColor))
                    {
                        fontColor = PowerEditorUtility.ColorCode2Color(ct.runtimeFontColor);
                    }

                    if (PowerEditorUtility.CheckColorCodeValid(ct.runtimeBackgroundColor))
                    {
                        backgroundColor = PowerEditorUtility.ColorCode2Color(ct.runtimeBackgroundColor);
                    }
                }
            ...
            if (ppa is PowerListAttribute)
            {
                ...
                string data = PowerEditorUtility.GetMemberName(property.propertyPath);
                string listPath = "";
                ...
                if (elementPattern.IsMatch(data))//PowerList works on list only
                {
                    ...
                    listPath = PowerEditorUtility.GetPrefixPath(property.propertyPath);
                    listPath = listPath.Substring(0, listPath.Length - 1);

                    listPath = PowerEditorUtility.GetPrefixPath(listPath);
                    listPath = listPath.Substring(0, listPath.Length - 1);
                ...
                else
                {
                    if (overrideDrawer == null)
                        overrideDrawer = (r, p, l) =>
                        {
                            return PowerEditorUtility.DrawErrorMessage(r,
            ...
            if (ppa is StringSelectorAttribute)
            {
                ...
                else if (overrideDrawer == null)
                {
                    ...
                    string listGetterMethodPath = PowerEditorUtility.GetPrefixPath(property.propertyPath) + ss.ListGetter;
                    MethodInfo methodInfo = PowerEditorUtility.GetMemberInfoResursively<MethodInfo>(serializedObject.targetObject.GetType(), listGetterMethodPath);

                    if (methodInfo != null && methodInfo.ReturnType == typeof(List<string>))
                    {
                        List<string> list = PowerEditorUtility.InvokeMethodRecursively(serializedObject.targetObject, listGetterMethodPath) as List<string>;
                        if (list != null)
                        {
                            if (list.Count != 0)
                            {
                                overrideDrawer = (r, p, l) =>
                                {
                                    ...
                                    if (contain)
                                    {
                                        value = PowerEditorUtility.DrawStringSelector(r, value, list, l);
                            ...
                            else
                            {
                                overrideDrawer = (r, p, l) =>
                                {
                                    return PowerEditorUtility.DrawWarningMessage(r,
            ...
            if (ppa is ElementSelectorAttribute)
            {
                ...
                else if (overrideDrawer == null)
                {
                    ...
                    string listGetterMethodPath = PowerEditorUtility.GetPrefixPath(property.propertyPath) + es.ListGetter;
                    MethodInfo methodInfo = PowerEditorUtility.GetMemberInfoResursively<MethodInfo>(serializedObject.targetObject.GetType(), listGetterMethodPath);


                    if (methodInfo != null)
                    {
                        object output = PowerEditorUtility.InvokeMethodRecursively(serializedObject.targetObject, listGetterMethodPath);
                        if (output == null)
                        {
                            overrideDrawer = (r, p, l) =>
                            {
                                ...
                                if (olist.Count != 0)
                                {
                                    ...
                                    overrideDrawer = (r, p, l) =>
                                    {
                                        ...
                                        if (contain)
                                        {
                                            ...
                                            displayValue = PowerEditorUtility.DrawStringSelector(r, displayValue, displayKeyList, l);
                                            height += EditorGUIUtility.singleLineHeight;
        ...
        public sealed override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (fieldInfo.FieldType.IsSubclassOf(typeof(PowerWidget)))
            {
                ...
                else
                {
                    ...
                    {
                        return PowerEditorUtility.DrawErrorMessage(position, fieldInfo.FieldType.Name + "' has no drawing tool!", (float)(1.5 * EditorGUIUtility.singleLineHeight));
                    };
                }
            }
