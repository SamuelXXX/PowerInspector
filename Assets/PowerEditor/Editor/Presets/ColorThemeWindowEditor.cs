...
namespace PowerEditor.Editor
{
    public class ColorThemeWindowEditor : EditorWindow
    {
        ...
        #region Menu
        [MenuItem("PowerEditor/Open Color Theme")]
        static void OpenColorTheme()
        {
            ...
            window.titleContent.text = "PowerEditorColorTheme";
            window.Show();
        }
        #endregion
        ...
        private void OnGUI()
        {
            ...
            try
            {
                ...
                EditorGUI.DrawTextureTransparent(position, Resources.Load<Texture>("logo"), ScaleMode.ScaleAndCrop);
