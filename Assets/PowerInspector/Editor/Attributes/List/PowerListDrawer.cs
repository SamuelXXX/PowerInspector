...
namespace PowerInspector.Editor
{
    public class PowerListDrawerManager
    {
        ...
        public static void BeginIndentLevel(int newLevel)
        {
        ...
        public float DrawPowerList(Rect position, Object targetObject, string listPropertyPath, string keyWord = null)
        {
            ...
            if (wrapper == null)
            {
                return PowerInspectorUtility.DrawErrorMessage(position, targetObject.name + "." + listPropertyPath + " is not a valid list-typed property path!");
            }
            ...
            position.x += EditorGUI.indentLevel * EditorGUIUtility.singleLineHeight;
            position.width -= EditorGUI.indentLevel * EditorGUIUtility.singleLineHeight;
